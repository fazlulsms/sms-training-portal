@extends('layouts.app')
@section('page-title', 'Create eLearning Course')
@section('content')
<style>
...
<div style="background:#fff; padding:28px; border-radius:14px; box-shadow:0 4px 16px rgba(0,0,0,.07);">
    ...
    <form method="POST" action="{{ route('elearning.courses.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div id="tab-basic" class="tab-panel active">
            <div class="frow">
                ...
                <div class="fg">
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" placeholder="e.g. SMS-EL-001">
                </div>
            </div>
            <div class="frow">
                <div class="fg">
                ...
                <div class="fg">
                    ...
                    <select name="language">
                        ...
                        <option value="English & Bangla" {{ old('language')=='English & Bangla'?'selected':'' }}>English &amp; Bangla</option>
                    </select>
                </div>
            </div>
            <div class="frow">
            ...
            <div class="frow">
                <div class="fg">
                    ...
                    <input type="text" name="duration" value="{{ old('duration') }}" placeholder="e.g. 4 Hours / Self-Paced">
                </div>
                <div class="fg">
                    <label>CPD Hours</label>
                    <input type="number" name="cpd_hours" value="{{ old('cpd_hours') }}" placeholder="e.g. 4">
                </div>
            </div>
            <div class="frow3">
                <div class="fg">
                    <label>Course Fee (BDT)</label>
                    <input type="number" step="0.01" name="course_fee" value="{{ old('course_fee') }}">
                </div>
                <div class="fg">
                ...
                <div class="fg">
                    ...
                    <input type="number" name="access_days" value="{{ old('access_days', 30) }}" placeholder="30">
                </div>
            </div>
            <div class="frow">
                <div class="fg">
                    <label>Passing Score (%)</label>
                    <input type="number" name="passing_score" value="{{ old('passing_score', 70) }}" min="1" max="100">
                </div>
                <div class="fg">
        ...
        <div id="tab-seo" class="tab-panel">
            <div class="fg">
                ...
                <input type="text" name="slug" value="{{ old('slug') }}" placeholder="e.g. iso-9001-elearning">
            ...
            <div class="fg">
                ...
                <input type="text" name="seo_keywords" value="{{ old('seo_keywords') }}" placeholder="ISO 9001, elearning, online course">
            </div>
        </div>
