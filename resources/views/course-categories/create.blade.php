...
<div style="background:#fff; padding:28px; border-radius:14px; box-shadow:0 4px 16px rgba(0,0,0,.07);">
    <h2 style="font-size:22px; font-weight:800; color:#111827; margin-bottom:24px;">Add Course Category</h2>
    @if($errors->any())
    ...
    @endif
    <form method="POST" action="/admin/course-categories/store" enctype="multipart/form-data">
        @csrf
        <div class="frow">
            <div class="fg">
            ...
            <div class="fg">
                ...
                <input type="text" name="slug" value="{{ old('slug') }}" placeholder="e.g. iso-standards">
            </div>
        </div>
        <div class="fg">
