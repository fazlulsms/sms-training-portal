...
<div class="certificate">
    <div class="border">
        ...
        <div class="header-area">
            ...
            <div class="subtitle">Awarded for successful completion of the professional training program</div>
        </div>
        ...
        <div class="content-area">
            ...
            <div class="course-text">
                This is to certify that the above-named participant has successfully completed the
        ...
        <div class="meta-bar">
            ...
            <div class="meta-statement">
                This certificate is digitally verifiable through the QR code and confirms successful completion of the stated professional training program.
            </div>
