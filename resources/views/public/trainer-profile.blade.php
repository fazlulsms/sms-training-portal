...
.cert-list li:before { content: '\2713'; color: #16a34a; font-weight: 900; margin-right: 10px; }
        ...
        <div class="profile-inner">
            ...
            <div>
                ...
                <div class="profile-badges">
                    @if($trainer->experience)<span class="profile-badge"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-1px;margin-right:4px"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>{{ $trainer->experience }}</span>@endif
                    @if($trainer->email)<a href="mailto:{{ $trainer->email }}" class="profile-badge" style="color:#fff; text-decoration:none;"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-1px;margin-right:4px"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22 6 12 13 2 6"/></svg>Contact</a>@endif
                </div>
            </div>
        </div>
    </div>
