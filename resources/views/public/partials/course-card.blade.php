@php
    ...
    [$catGrad, $catIcon] = match(true) {
        ...
        str_contains($catRaw, 'quality')         => ['#1e3a8a,#2563eb', '<polyline points="22 11.08 12 2 2 11.08" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 22V12h6v10" stroke="#fff" stroke-width="1.6" stroke-linecap="round"/><path d="M2 22h20" stroke="rgba(255,255,255,.5)" stroke-width="1.5" stroke-linecap="round"/><path d="M12 6l1.5 3 3.3.5-2.4 2.3.6 3.2L12 13.5l-3 1.5.6-3.2-2.4-2.3 3.3-.5z" stroke="#fff" stroke-width="1.3" fill="rgba(255,255,255,.2)"/>'],
        str_contains($catRaw, 'leader') ||
        str_contains($catRaw, 'manag')           => ['#0f2470,#0f2470', '<circle cx="12" cy="8" r="5" stroke="#fff" stroke-width="1.6"/><path d="M12 13v9" stroke="#fff" stroke-width="1.6" stroke-linecap="round"/><path d="M8 22h8" stroke="rgba(255,255,255,.6)" stroke-width="1.6" stroke-linecap="round"/><path d="M6 17c1-1 3-1.5 6-1.5s5 .5 6 1.5" stroke="rgba(255,255,255,.5)" stroke-width="1.4" stroke-linecap="round"/>'],
