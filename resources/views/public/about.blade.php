...
<div class="pub-container">
    ...
    <div class="abt-cats-grid">
        ...
        $categories = [
            ...
            ['icon'=>'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>', 'title'=>'Grievance Management Systems', 'desc'=>'Grievance mechanism design, worker complaint handling, remediation processes, and case management systems.'],
            ['icon'=>'<polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>', 'title'=>'Workplace Harassment & Abuse Prevention', 'desc'=>'Anti-harassment policy development, investigation procedures, safe reporting channels, and workplace conduct standards.'],
            ['icon'=>'<path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>', 'title'=>'Gender-Based Violence Prevention', 'desc'=>'GBV risk assessment, prevention training, survivor support frameworks, and workplace policy development.'],
            ['icon'=>'<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/><line x1="2" y1="2" x2="22" y2="22"/>', 'title'=>'Modern Slavery & Forced Labour', 'desc'=>'Due diligence, recruitment fee monitoring, debt bondage indicators, and remediation planning.'],
            ['icon'=>'<polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>', 'title'=>'Ethical Business Conduct', 'desc'=>'Anti-bribery management (ISO 37001), business ethics, code of conduct implementation, and whistleblower protection.'],
        ];
        @endphp
