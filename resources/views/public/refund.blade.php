...
.rp-step-num { width:28px; height:28px; border-radius:50%; background:linear-gradient(135deg,#042C53,#042C53); color:#fff; font-size:12px; font-weight:900; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
...
<div class="legal-grid">
    ...
    <div class="legal-content">
        ...
        <p>The following refund schedule applies to all in-person Instructor-Led Training programmes. Cancellations must be submitted in writing to <a href="mailto:training@smscert.com" style="color:#042C53;">training@smscert.com</a>. The number of calendar days is calculated from the date the written cancellation request is received to the scheduled first day of the programme.</p>
        ...
        <p>For enquiries about corporate programme cancellations or adjustments, contact: <a href="mailto:info@smscert.com" style="color:#042C53;">info@smscert.com</a></p>
        ...
        <p>To submit an exceptional circumstances request, contact <a href="mailto:training@smscert.com" style="color:#042C53;">training@smscert.com</a> with the subject line "Exceptional Circumstances Request" and attach relevant supporting documents.</p>
        ...
        <div class="rp-process-steps">
            <div class="rp-step">
                ...
                <div>
                    ...
                    <p>Email <a href="mailto:training@smscert.com" style="color:#042C53;">training@smscert.com</a> with the subject "Refund Request — [Your Full Name] — [Programme Name]". Include your enrolment date, programme start date, reason for cancellation, and any supporting documents.</p>
                </div>
            </div>
            <div class="rp-step">
        ...
        <div style="background:#f8fafc;border:1.5px solid #e9ecf0;border-radius:12px;padding:20px;margin-top:10px;">
            ...
            <p style="margin:0 0 4px;"><a href="mailto:training@smscert.com" style="color:#042C53;">training@smscert.com</a> <span style="color:#9ca3af;font-size:12px;">(preferred — for refund requests, include programme name and enrolment date)</span></p>
