...
<div style="max-width:1100px; margin:auto;">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
        <div>
            <h2 style="font-size:22px; font-weight:800; color:#111827; margin:0 0 4px;">Industries</h2>
            <div style="font-size:13px; color:#6b7280;">
                Layer 4 · LTF Taxonomy ·
        ...
        <a href="{{ route('setup.industries.create') }}"
    ...
    @include('admin.setup._tabs', ['active' => 'industries'])
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f3f4f6;">
                    ...
                    <td style="padding:12px 16px; text-align:center;">
                        <form method="POST" action="{{ route('setup.industries.toggle', $rec) }}" style="display:inline;">
                            @csrf @method('PATCH')
                    ...
                    <td style="padding:12px 16px; text-align:center; white-space:nowrap;">
                        <a href="{{ route('setup.industries.edit', $rec) }}" style="color:#1e3a8a; font-weight:600; font-size:13px; text-decoration:none; margin-right:12px;">Edit</a>
                        <form method="POST" action="{{ route('setup.industries.destroy', $rec) }}" style="display:inline;" onsubmit="return confirm('Delete {{ addslashes($rec->name) }}?')">
                            @csrf @method('DELETE')
                ...
                @empty
                <tr><td colspan="6" style="padding:40px; text-align:center; color:#9ca3af;">No industries yet. <a href="{{ route('setup.industries.create') }}" style="color:#1e3a8a;">Add the first one.</a></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
