...
<div style="max-width:680px; margin:auto;">
    <div style="margin-bottom:20px;">
        <a href="{{ route('setup.training-models.index') }}" style="color:#6b7280; font-size:13px; text-decoration:none;">← Training Models</a>
    </div>
    <div style="background:#fff; border-radius:12px; box-shadow:0 2px 8px rgba(0,0,0,.06); padding:28px;">
        <h2 style="font-size:20px; font-weight:800; color:#111827; margin:0 0 24px;">Edit Training Model</h2>
        ...
        <form method="POST" action="{{ route('setup.training-models.update', $record) }}">
            @csrf @method('PUT')
            ...
            <div style="display:flex; gap:12px;">
                ...
                <a href="{{ route('setup.training-models.index') }}" style="padding:10px 20px; border:1.5px solid #d1d5db; border-radius:8px; font-weight:600; font-size:14px; color:#374151; text-decoration:none;">Cancel</a>
            </div>
        </form>
    </div>
</div>
