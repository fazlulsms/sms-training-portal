...
<div style="max-width:700px; margin:auto;">
    ...
    <div style="display:flex; align-items:center; gap:12px; margin-bottom:24px;">
        ...
        <h2 style="font-size:22px; font-weight:800; color:#111827; margin:0;">Edit Course Type</h2>
    </div>
    ...
    <div style="background:#fff; border-radius:12px; box-shadow:0 2px 8px rgba(0,0,0,.06); padding:28px;">
        <form method="POST" action="{{ route('setup.course-types.update', $record) }}">
            @csrf @method('PUT')
            @include('admin.setup.course-types._form', ['record' => $record])
