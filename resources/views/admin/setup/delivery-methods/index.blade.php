...
<div style="max-width:1100px; margin:auto;">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
        <div>
            <h2 style="font-size:22px; font-weight:800; color:#111827; margin:0 0 4px;">Delivery Methods</h2>
            <div style="font-size:13px; color:#6b7280;">
                Dimension 1 · LTF Taxonomy ·
        ...
        <a href="{{ route('setup.delivery-methods.create') }}"
    ...
    @include('admin.setup._tabs', ['active' => 'delivery-methods'])
        ...
        <table style="width:100%; border-collapse:collapse;">
            <thead>
                <tr style="background:#f8fafc; border-bottom:2px solid #e5e7eb;">
                    ...
                    <th style="padding:11px 16px; text-align:left; font-size:11px; font-weight:700; color:#6b7280; text-transform:uppercase; letter-spacing:.5px;">Description</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f3f4f6;">
                    ...
                    <td style="padding:12px 16px; font-size:13px; color:#9ca3af; max-width:340px;">{{ $rec->description ? \Illuminate\Support\Str::limit($rec->description, 90) : '—' }}</td>
                    ...
                    <td style="padding:12px 16px; text-align:center;">
                        <form method="POST" action="{{ route('setup.delivery-methods.toggle', $rec) }}" style="display:inline;">
                            @csrf @method('PATCH')
                    ...
                    <td style="padding:12px 16px; text-align:center; white-space:nowrap;">
                        <a href="{{ route('setup.delivery-methods.edit', $rec) }}" style="color:#1e3a8a; font-weight:600; font-size:13px; text-decoration:none; margin-right:12px;">Edit</a>
                        <form method="POST" action="{{ route('setup.delivery-methods.destroy', $rec) }}" style="display:inline;" onsubmit="return confirm('Delete {{ addslashes($rec->name) }}?')">
                            @csrf @method('DELETE')
                ...
                @empty
                <tr><td colspan="6" style="padding:40px; text-align:center; color:#9ca3af;">No delivery methods yet. <a href="{{ route('setup.delivery-methods.create') }}" style="color:#1e3a8a;">Add the first one.</a></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
