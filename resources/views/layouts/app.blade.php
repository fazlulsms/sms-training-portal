...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* Feedback group — rose accent */
        .sg-feedback .sb-group-label { color: #fb7185; }
        /* Admin group */
    ...
    @else
        ...
        <div class="sb-group sg-il"
            ...
            <div class="sb-group-items" x-show="open" x-transition>
                ...
                <a href="/admin/question-sets"
                   class="sb-sub {{ request()->is('admin/question-sets*') ? 'active' : '' }}">
                    <span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="12" y1="17" x2="8" y2="17"/><path d="M16 17h-4"/></svg></span>
                    Question Sets
                </a>
        ...
        <div class="sb-group sg-feedback"
            ...
            <div class="sb-group-items" x-show="open" x-transition>
                ...
                <a href="{{ route('feedback.responses.index') }}"
                   class="sb-sub {{ request()->is('feedback/responses*') ? 'active' : '' }}">
        ...
        <div class="sb-group sg-admin"
            ...
            <div class="sb-group-items" x-show="open" x-transition>
                ...
                <a href="{{ route('ai.prompt-templates.index') }}"
                   class="sb-sub {{ request()->is('admin/ai/prompt-templates*') ? 'active' : '' }}">
                    <span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg></span>
                    Prompt Templates
                </a>
